...
export const BUILTIN_COMMANDS = [
  ...
  { cmd: '/use ',                 description: 'Switch to a named agent (starts it if needed)' },
  { cmd: '/agents',               description: 'List configured agents — running/stopped, which is active' },
  { cmd: '/agents stop ',         description: 'Stop a running agent' },
  { cmd: '/agents remove ',       description: 'Remove an agent from config' },
  { cmd: '/config llamacpp agent ', description: 'Configure a named agent (model, port, context, args)' },
  ...
  { cmd: '/config llamacpp modelsdir ',  description: 'Folder to browse for .gguf files' },
  { cmd: '/models local',                description: 'List .gguf files in that folder, numbered' },
  { cmd: '/config llamacpp model ',      description: 'Switch model — path or number from /models local' },
  { cmd: '/config llamacpp context ',    description: 'Set context length in tokens' },
  ...
  { cmd: '/config llamacpp args ',       description: 'Advanced: raw extra llama-server flags' },
